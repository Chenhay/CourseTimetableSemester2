...
public final class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jpHome.setBackground(new java.awt.Color(31, 58, 146));
    ...
    private void OnMouseLabelClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OnMouseLabelClicked
        if(evt.getComponent().getName().equalsIgnoreCase("Exit")){
            int choice=JOptionPane.showConfirmDialog(null, "Do you want to Exit ?", "Exit", JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
            if(choice==0){
                System.exit(0);
            }
            else if(choice==1){
